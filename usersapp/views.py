...
def register_view(request):
    if request.method == 'POST':
        ...
        lat, lon = get_coords_from_address(adresa)
...
def dashboard_view(request):
    ...
    context = {
        "user": u,
        "user_has_map_access": user_has_map_access,
        "user_not_has_map_access": user_not_has_map_access
    }
